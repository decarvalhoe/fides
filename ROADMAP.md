...
| **v0.4** | **Workflow pro** : mode batch (dossier), normalisation **album/anchor**, A/B aligné en loudness, rapport **HTML**, packaging (`pyproject` + entry point `dlz`) | en cours |
...
3. **Simple** : une commande, des profils, des défauts sûrs. `dlz IN.wav -o OUT/`.
